...
client.on('message', message => {
    ...
    if (command === 'youtube') {
        ...
        if (!args.length) {
            ...
            .setThumbnail(client.guilds.resolve(704885544986869841).users.resolve(142126035301957632).user.avatarURL())
            .setFooter('Last Updated by DoritoSoup on 7/17/2020.', bot.guilds.resolve(704885544986869841).users.resolve(357663989418688513).user.avatarURL());
