...
client.on('message', message =>{
    ...
    if (command === 'youtube'){
        ...
        message.channel.send('The current Soup clan members are:', ' <@142126035301957632>', '<@357663989418688513>', '<@399172695213735936>', '<@622181058841935883>', '<@330761771943985155>', '<@513683756012273664>', '<@398587405369737217>');
    }
