...
client.on('message', message =>{
    ...
    if (command === 'youtube'){
        ...
        message.channel.send('The current Soup Kitchen members are:').send('<@142126035301957632>').send('<@357663989418688513>').send('<@399172695213735936>').send('<@622181058841935883>').send('<@330761771943985155>').send('<@513683756012273664>').send('<@398587405369737217>');
    }
